...
public class BatchConfiguration {
	...
	// Constant field names that need to be pass to be read.
  ...
  // Reader reads input data from .csv file. 
  @Bean
  ...
  //Processor calls "MatchInputDataProcessor" to process data. 
  @Bean
  public MatchInputDataProcessor processor() {
    return new MatchInputDataProcessor();
  }

  // Writer writes data to out put, "Match". 
  @Bean
